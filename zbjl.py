    ...
    for one_record in eval('list_' + type + '.select()'):
        ...
        for page in range(1,end_page+1):
            ...
            for item in data_list:
                ...
                # if eval(query_cmd):
                #     print('[+]', type, 'zbjl', one_record.num_zb, one_record.name_zb, webcast_id, 'Done at', get_current_time())
                #     continue
                ...
                # Table_obj.save()
                #
                # print('[+]', type, 'zbjl', one_record.num_zb, one_record.name_zb, webcast_id, detail_data.get('create_time'), 'Done at', get_current_time())
